...
<script type="text/javascript">
	$(function(){
		$("#username").change(function(){
			...
			$.get("${pageContext.request.contextPath}/userController?method=checkName","username="+this.value,function(data){
				if(data.data==0){
					console.info(data);
	...
	<div class="regist">
		<div class="regist_center">
			...
			<div class="center-block" style="margin-top: 80px;">
				<form class="form-horizontal" action="${pageContext.request.contextPath}/userController?method=register" method="post">
