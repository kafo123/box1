...
<script type="text/javascript">
	$(function(){
		...
		$("#pagecode").click(function(){
			$("#pagecode").attr("src","${pageContext.request.contextPath}/userController?method=code&r="+Math.random());
		});
		//3.验证输入的验证码 是否正确
...
<body>
		...
		<form  method="post" action="${pageContext.request.contextPath}/userController?method=login" class="form center" id="userLogin" >
		<div class="login">
			<div class="login_center">
				...
				<div class="login_main center">
					...
					<div class="username">
						...
						<img  id="pagecode" src="${pageContext.request.contextPath}/userController?method=code"><label id="checkMsg"></label></div>
					</div>
					<div class="username">
