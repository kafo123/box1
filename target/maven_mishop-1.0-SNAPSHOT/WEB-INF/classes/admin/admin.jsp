		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/goodsController?method=adminGetAllType");
				})
				$("#addGoodsType").click(function(){
					$(".dv_content").attr("src","addGoodsType.jsp");
				})
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/goodsController?method=getAllProduct");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","addGoods.jsp");
				})
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/orderController?method=getAllOrder");
				})
			</script>
