		...
		<div class="row">
		  <div class="col-xs-6 col-md-6">
		    <a href="#" class="thumbnail">
		      <img src="${pageContext.request.contextPath}/${goods.pImage}"  width="560" height="560"  alt="${goods.tName}" />
		    </a>
		  </div>
		  <div class="col-xs-6 col-md-6">
			  ...
			  <div class="panel-body">
			    ...
			    <div style="margin-left: 10px;">
				   ...
				   <p>市场价格:&nbsp;&nbsp;&nbsp;<span class="text-danger" style="font-size: 15px;">${goods.pPrice}</span>&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-yen"></span></p>
				    ...
				    <p>详细介绍:</p>
				    <p>&nbsp;&nbsp;${goods.pInfo }</p>
				    <a href="${pageContext.request.contextPath}/cartController?method=addGoodsToCart&goodsId=${goods.pId}&price=${goods.pPrice}" class="btn btn-warning">加入购物车&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-shopping-cart"></span></a>&nbsp;&nbsp;&nbsp;
